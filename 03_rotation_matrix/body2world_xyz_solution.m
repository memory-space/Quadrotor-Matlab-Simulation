function R_b_w = body2world_xyz_solution(phi, theta, psi)
    ...
    %% Uncomment and write body2world_xyz_solution(1, 3, 2) to command then check1 from isequal 
    % ! Check and comment again with Ctrl T
